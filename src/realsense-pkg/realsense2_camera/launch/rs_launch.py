...
configurable_parameters = [{'name': 'camera_name',                  'default': 'latuuu_camera', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'latuuu_camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': '_313522072696', 'description': 'choose device by serial number'},
